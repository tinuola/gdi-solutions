...
/**** Functions ****/
/*
Declare a function 'oddOrEven' that takes 'num' as a parameter. This function checks to see if a number is even or odd, and prints a message. Verify that the function works by running it with an argument (an actual number).
*/
...
/*
Declare a function 'trueOrFalse' that takes a boolean value and returns 'Yes' if that value is true, or 'No' if the value is false, or 'This is not a boolean.' if it's any other value. Run the function.
*/
